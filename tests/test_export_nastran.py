...
def test_tabled1_re_im_snippets_use_free_field_format():
    ...
    assert lines[2] == "+,1.1000000000000000E+01,-3.0000000000000000E+00"
    assert lines[3] == "+,ENDT"
    assert lines[4] == "TABLED1,1002,LINEAR,LINEAR"
    assert lines[5] == "+,1.0000000000000000E+01,-2.5000000000000000E+00"
    assert lines[6] == "+,1.1000000000000000E+01,4.7500000000000000E+00"
    assert lines[7] == "+,ENDT"
...
def test_tabrnd1_snippet_use_free_field_format():
    ...
    assert lines[2] == "+,2.0000000000000000E+01,5.0000000000000000E-01"
    assert lines[3] == "+,ENDT"
